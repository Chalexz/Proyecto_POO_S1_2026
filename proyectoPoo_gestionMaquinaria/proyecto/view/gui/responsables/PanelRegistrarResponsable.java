...
public class PanelRegistrarResponsable extends JPanel {
    ...
    private void registrarResponsable() {
        ...
        String fechaNacimiento = camFechaNacimiento.getText().trim();
        String nombreCompleto = camNombreCompleto.getText().trim();

        if (identificacion.isEmpty() || fechaNacimiento.isEmpty() || nombreCompleto.isEmpty()) {
            DialogoMensaje.mostrarAdvertencia(this, "Por favor, complete todos los campos.");
            return;
        }
        DialogoMensaje.mostrarExito(this, "Responsable con identificación '" + identificacion + "' registrado exitosamente.");
        camResultado.setText("Responsable con identificación '" + identificacion + "' registrado exitosamente.");
    }
}