...
public class MauinariaAsignadaResponsable extends JPanel {
    private JTextField camIdentificacion;
    private JTextArea camResultado;
    
    public MauinariaAsignadaResponsable() {
        ...
        // Titulo
        JLabel titulo = new JLabel("Consultar maquinaria asignada a responsable");
        ...
        btnConsultar.addActionListener(e -> {
            consultarMaquinariaAsignada();
        });
    }

    private void consultarMaquinariaAsignada() {
        String identificacion = camIdentificacion.getText().trim();
        if (identificacion.isEmpty()) {
            DialogoMensaje.mostrarAdvertencia(this, "Por favor, ingrese la identificación del responsable a consultar.");
            return;
        }
        camResultado.setText("Maquinaria asignada al responsable con identificación '" + identificacion + "':\n- Maquinaria 1\n- Maquinaria 2\n...");
    }
}