...
public class PanelRegistrarEquipoIndustrial extends JPanel{
    ...
    public PanelRegistrarEquipoIndustrial(){
        ...
        // Titulo
        JLabel titulo = new JLabel("Registrar equipo industrial");
        ...
        peso = ConstructorCampos.crearCampoTexto(12);
        volumen = ConstructorCampos.crearCampoTexto(12);

        filaDoble3.add(ConstructorCampos.crearCampoConEtiqueta("Peso", peso));
        filaDoble3.add(Box.createHorizontalStrut(25));
        filaDoble3.add(ConstructorCampos.crearCampoConEtiqueta("Volumen", volumen));
