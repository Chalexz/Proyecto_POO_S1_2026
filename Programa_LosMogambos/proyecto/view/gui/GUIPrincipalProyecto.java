    ...
    public static void main(String[] args) {
        ...
        PanelRegistrarResponsable.getBotonRegistrar().addActionListener(e ->{
            ...
            if (!validador.esStringValido(pIdentificacion)) {
                DialogoMensaje.mostrarAdvertencia(
                    PanelRegistrarResponsable, "La identificación no puede estar vacía.");
                return;
            }
            if (!validador.esFechaValida(pFechaNacimiento)) {
                DialogoMensaje.mostrarAdvertencia(
                    PanelRegistrarResponsable, "La fecha de nacimiento no es válida. Use el formato dd/mm/aaaa.");
                return;
            }
            if (!validador.esStringValido(pNombreCompleto)) {
                DialogoMensaje.mostrarAdvertencia(
                    PanelRegistrarResponsable, "El nombre completo no puede estar vacío.");
                return;
            }
